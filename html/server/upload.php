    ...
    if($image_res){
        ...
        //call normal_resize_image() function to proportionally resize image
           ...
           if(strstr($_SERVER['HTTP_USER_AGENT'],'iPhone') || strstr($_SERVER['HTTP_USER_AGENT'],'iPod')){
                        echo '<img src="http://squibturf.com/media/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail" height="100" id="squib_preview" class="iphone-image" />';
            } else{
                   echo '<img src="http://squibturf.com/media/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail" height="100" id="squib_preview" />';
            }
            echo '</div>';
